...
I am interested in promoting the accuracy, standardization and intelligence of Synthetic Aperature Radar Interferometry (InSAR) in the big data era, applying InSAR technique to landslides identification, mechanics understanding and modeling. My current focuses include:

\begin{itemize}
  \item Advanced InSAR time series processing techniques (e.g., PS, DS, phase linking, phase unwrapping and atmospheric delay correction) 
  ...
  \item Accurate and interative InSAR big data visualization
...
\vspace{-\parskip}%
\begin{itemize}[label={}]
  \item Ph.D.\ in Geophysics \printdate{Jul 2021~--~now}
...
\vspace{-\parskip}%
\begin{itemize}
  %\item 5000+ downloads on conda-forge, 8000+ downloads on PyPI.
  \item A flexiable library with necessary infrastructure rather than a workflow like StamPS, MintPy, and Dolphin.
  \item Most robust and faster InSAR processing with deep learning.
  \item State-of-the-art Persistant Scatterer/Distributed Scatterer techniques.
  \item Best practice for scientific computing with massively parallel computing support (GPU/CPU).
...
\section{Awards \texorpdfstring{\&}{i} Fellowships} 

\begin{itemize}
  \item O’Donnell Data Science and Research Computing Institute Fellowship, \$25,000 for 10 mounths, SMU \printdate{2024}
